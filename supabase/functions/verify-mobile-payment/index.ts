  ...
  if (payload.action === "request") {
    ...
    const providerResponse = await fetch("https://api.resend.com/emails", {
      ...
      headers: {
        ...
        "Idempotency-Key": `checkout-otp-${challengeId}`,
      },
      body: JSON.stringify({
        ...
        html:
          `<!doctype html><html><body style="margin:0;background:#f3efe8;font-family:Arial,sans-serif;color:#24211e"><div style="display:none;max-height:0;overflow:hidden;opacity:0">Your secure CozyCraft payment code is ${code}.</div><div style="padding:32px 14px"><div style="max-width:620px;margin:auto;background:#fff;border:1px solid #e1d9ce;border-radius:24px;overflow:hidden"><div style="padding:28px 32px;border-bottom:1px solid #e5ded3;text-align:center"><img src="${canonicalOrigin}/email-logo.png" alt="CozyCraft Furnitures" width="150" style="max-width:150px;height:auto"><p style="margin:12px 0 0;font-size:10px;font-weight:bold;letter-spacing:2.2px;color:#756e65">SECURE PAYMENT</p></div><div style="padding:34px 32px"><p style="margin:0 0 14px">Hello ${
