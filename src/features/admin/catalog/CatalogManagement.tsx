...
} from "@/lib/catalog/product-identity";
import {
  clearAdminDraft,
  readAdminDraft,
  writeAdminDraft,
...
const emptyManagedProduct = (): ManagedProduct => ({
  id: "",
  name: "",
  description: "",
...
export function ProductManager() {
  ...
  const [editing, setEditing] = useState<ManagedProduct | null>(() =>
    readAdminDraft(productEditorDraftKey, isManagedProductDraft) ??
    (location.pathname.endsWith("/new") ? emptyManagedProduct() : null),
  );
