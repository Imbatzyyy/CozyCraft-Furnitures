...
const router = createBrowserRouter([
  ...
  { path: "/terms", lazy: () => import('@/features/storefront/LegalPolicy') },
  { path: "/privacy", lazy: () => import('@/features/storefront/LegalPolicy') },
  { path: "/refunds", lazy: () => import('@/features/storefront/LegalPolicy') },
