...
export const defaultStoreSettings: PublicStoreSettings = {
  ...
  store_description:
    "Thoughtful furniture for comfortable Philippine homes, with one connected experience for discovery, secure checkout, delivery tracking, reviews, and customer care.",
  currency_code: "PHP",
